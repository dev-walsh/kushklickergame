...
🚀 Ready to start? Click the button below to open the game!
      ...
      const keyboard = {
        reply_markup: {
          inline_keyboard: [
            [{ text: '🎮 Play KushKlicker', web_app: { url: `https://a99bb73b-e548-458d-87fb-41dcd8dbe65b-00-3s8lic1pt8ip0.janeway.replit.dev?ref=${username}` } }],
...
Keep clicking to earn more! 🚀
        ...
        const keyboard = {
          reply_markup: {
            inline_keyboard: [
              [{ text: '🎮 Continue Playing', web_app: { url: `https://a99bb73b-e548-458d-87fb-41dcd8dbe65b-00-3s8lic1pt8ip0.janeway.replit.dev` } }]
            ]
          }
        };
    ...
    bot.onText(/\/leaderboard/, async (msg) => {
      ...
      try {
        ...
        const keyboard = {
          reply_markup: {
            inline_keyboard: [
              [{ text: '🎮 Play Now', web_app: { url: `https://a99bb73b-e548-458d-87fb-41dcd8dbe65b-00-3s8lic1pt8ip0.janeway.replit.dev` } }]
            ]
          }
        };
...
You can now use /stats to check your progress!
    ...
    const menuButtonUrl = 'https://a99bb73b-e548-458d-87fb-41dcd8dbe65b-00-3s8lic1pt8ip0.janeway.replit.dev';
